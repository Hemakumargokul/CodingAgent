...
context7 = MCPServerStdio(
    command="npx", args=["-y", "@upstash/context7-mcp"], tool_prefix="context", timeout=120
)

internet_search = MCPServerStdio(command="uvx", args=["duckduckgo-mcp-server"], timeout=120)
